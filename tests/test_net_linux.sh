...
sleep 0.5
kill $GROTTO_PID 2>/dev/null || true
wait $GROTTO_PID 2>/dev/null || true
...
timeout 2 ./build/grotto -c 127.0.0.1 -p 18235 -k $KEY 2>/dev/null || true
